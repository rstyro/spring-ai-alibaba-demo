package top.lrshuai.ai.image.controller;
...
public class DashScopeImageController {
    ...
    @GetMapping("/image")
    public void image(HttpServletResponse response, @RequestParam(value = "prompt", defaultValue = DEFAULT_PROMPT) String prompt) {
