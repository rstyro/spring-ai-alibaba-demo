...
public class PromptNacosSystemApplication {

    public static void main(String[] args) {
        ConfigurableApplicationContext applicationContext = SpringApplication.run(PromptNacosSystemApplication.class, args);
